...
class __Mustache_979d49821a63320c0cf650fa9c868720 extends Mustache_Template
{
...
';
        ...
        $value = $context->find('hidden');
        $buffer .= $this->section3a2fbaea4c4606b9cc8dc261b489f232($context, $indent, $value);
        $buffer .= $indent . '
';
        $buffer .= $indent . '</a>
';
    ...
    private function section3a2fbaea4c4606b9cc8dc261b489f232(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
