...
class __Mustache_9b72126809fb6ed7d0db334634da6af7 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section1dfe90a98257cb5d5aa815b426f98b98($context, $indent, $value);
        $buffer .= $indent . '
';
...
';
        $buffer .= $indent . '                        ';
        $value = $this->resolveValue($context->findDot('output.course_content_footert_header'), $context);
        $buffer .= ($value === null ? '' : $value);
        $buffer .= '
';
        $buffer .= $indent . '                        ';
...
';
        ...
        $buffer .= $this->sectionA9a3a5548223a7f7acf4973922515919($context, $indent, $value);
        $buffer .= $indent . 'aaaaaaaaaaaaaaaa
';
...
';
    ...
    private function section1dfe90a98257cb5d5aa815b426f98b98(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionA9a3a5548223a7f7acf4973922515919(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            <section id="faq" class="scale-up scale-up-show">
                <div class="moove-container-fluid">
                    <h2>Preguntas Frecuentes <!--{{#str}}faq, theme_moove{{/str}}--></h2>
...
';
                $buffer .= $indent . '                <div class="moove-container-fluid">
';
                $buffer .= $indent . '                    <h2>Preguntas Frecuentes <!--';
                $value = $context->find('str');
