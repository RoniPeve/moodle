...
class __Mustache_c30e7d3bd004b2e5c2b03db017a9ce73 extends Mustache_Template
{
...
';
        ...
        if (empty($value)) {
            ...
            $buffer .= $this->section573a3479b0877c73f6d5c79de03706a2($context, $indent, $value);
        }
...
';
    ...
    private function section573a3479b0877c73f6d5c79de03706a2(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
