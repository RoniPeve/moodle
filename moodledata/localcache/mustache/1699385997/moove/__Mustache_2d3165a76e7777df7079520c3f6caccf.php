...
class __Mustache_2d3165a76e7777df7079520c3f6caccf extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionF82ecc14debe90e7990a75ffad16cc79($context, $indent, $value);
        $buffer .= $indent . '</div>';
...
';
    ...
    private function sectionE4f2eb0d6d5747529f511261ffce9168(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '
                <div class="customfields campos">
...
';
    ...
    private function sectionF82ecc14debe90e7990a75ffad16cc79(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->sectionE4f2eb0d6d5747529f511261ffce9168($context, $indent, $value);
                $buffer .= $indent . '        </div>
';
                $buffer .= $indent . '        
';
