...
class __Mustache_8620f7015ce0286d4ff9671c30444d9c extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->sectionEc2c05edb3bec7a86985141ca1059495($context, $indent, $value);
    ...
    private function sectionC7c2ee7b5fb197006107e15fa28af43b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionEc2c05edb3bec7a86985141ca1059495(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $buffer .= $indent . '        <button class="btn btn-outline-dark dropdown-toggle ml-1" data-toggle="dropdown" id="addcolumndropdown" aria-haspopup="true" aria-expanded="false">
';
                $buffer .= $indent . '            ';
...
';
                ...
                $buffer .= $this->sectionC7c2ee7b5fb197006107e15fa28af43b($context, $indent, $value);
                $buffer .= $indent . '        </div>
';
                $buffer .= $indent . '    </div>
';
