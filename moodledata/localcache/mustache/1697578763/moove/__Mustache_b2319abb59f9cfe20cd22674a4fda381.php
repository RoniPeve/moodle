...
class __Mustache_b2319abb59f9cfe20cd22674a4fda381 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section9a73967b9e7e5fd76ad1aea813bae25f($context, $indent, $value);
        $buffer .= $indent . '        </div>
';
        $buffer .= $indent . '    </div>
';
...
';
    ...
    private function section276e94851e13883fcd09002099df5259(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section9a73967b9e7e5fd76ad1aea813bae25f(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $this->section276e94851e13883fcd09002099df5259($context, $indent, $value);
                $context->pop();
            }
        }
