...
class __Mustache_7de6e26a4a61094fedf5253fe2a0eac8 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionF2a54257fe4b501c7ec1bf1b2b122df8($context, $indent, $value);
        $buffer .= $indent . '
';
...
';
    ...
    private function sectionF2a54257fe4b501c7ec1bf1b2b122df8(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            <section id="faq" class="scale-up scale-up-show">
                <div class="moove-container-fluid">
                    <h2><!--{{#str}}faq, theme_moove{{/str}}-->Preguntas Frecuentes</h2>
...
';
                ...
                $buffer .= '-->Preguntas Frecuentes</h2>
';
                $buffer .= $indent . '
';
