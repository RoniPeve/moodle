...
class __Mustache_1dbc96ebcfb18293ade0c6387d90f05c extends Mustache_Template
{
...
';
        $buffer .= $indent . '</div>
';
        $buffer .= $indent . '<!-----------agregar footer------------>
';
        $buffer .= $indent . '<!-------- theme_moove/footer agregar los corchetes a los lados----->
';
