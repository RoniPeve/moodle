...
class __Mustache_244e98a35cd6595bc9ea08648f8d27b0 extends Mustache_Template
{
...
';
        ...
        $buffer .= '
';
        $buffer .= $indent . '    <!------------------CODIGO MODIFICADO PARA EL LOGIN-------------------------------------->
';
...
';
        $buffer .= $indent . '    </div>
';
        $buffer .= $indent . '    <!------------------FIN CODIGO MODIFICADO PARA EL LOGIN-------------------------------------->
';
...
';
        $buffer .= $indent . '                        <div class="diagonal_login">
';
        $buffer .= $indent . '                    
';
        $buffer .= $indent . '                        </div>
...
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '      // Reiniciar el cambio automático
';
        $buffer .= $indent . '      clearInterval(autoChangeInterval);
';
        $buffer .= $indent . '      autoChangeInterval = setInterval(autoChangeSlide, 3000);
';
        $buffer .= $indent . '    });
';
        $buffer .= $indent . '  });
...
';
        $buffer .= $indent . '  let autoChangeInterval = setInterval(autoChangeSlide, 3000);
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '  updateSlider();
