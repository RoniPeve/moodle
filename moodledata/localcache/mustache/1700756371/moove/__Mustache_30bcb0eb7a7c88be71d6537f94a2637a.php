...
class __Mustache_30bcb0eb7a7c88be71d6537f94a2637a extends Mustache_Template
{
...
';
        $buffer .= $indent . '                <div class="enlaces">
';
        $buffer .= $indent . '                    <p >Enlaces de Interés</p>
';
        $buffer .= $indent . '                    <ul>
';
        $buffer .= $indent . '                        <li>
';
        $buffer .= $indent . '                            <a href="https://www.gob.pe/ceplan" target="_blank">Página web del Ceplan</a>
';
        $buffer .= $indent . '                        
';
        $buffer .= $indent . '                        </li>
';
        $buffer .= $indent . '                        <li>
';
        $buffer .= $indent . '                            <a href="https://geo.ceplan.gob.pe/" target="_blank">Plataforma de información territorial</a>
';
        $buffer .= $indent . '                        
';
        $buffer .= $indent . '                        </li>
';
        $buffer .= $indent . '                        <li>
';
        $buffer .= $indent . '                            <a href="https://observatorio.ceplan.gob.pe/inicio" target="_blank">Observatorio Nacional de Prospeciva</a>
';
        $buffer .= $indent . '                        
';
        $buffer .= $indent . '                        </li>
...
';
        $buffer .= $indent . '                    <h3 class="footer-title">Redes Sociales</h3>
';
        $buffer .= $indent . '
';
...
';
        $buffer .= $indent . '                </div>-->
';
        $buffer .= $indent . '                <div class="contacto">
';
        $buffer .= $indent . '                    <div>
';
        $buffer .= $indent . '                        <p>Contacto</p>
';
        $buffer .= $indent . '                        <ul>
';
        $buffer .= $indent . '                            <li><i class="fa fa-map-marker"></i> Dirección:</li>
';
        $buffer .= $indent . '                            <li>Av. Canaval y Moreyra 480 - Piso 21 - Edificio <br> Chocavento. San Isidro, Lima, Perú.</li>
';
        $buffer .= $indent . '                        </ul>
';
        $buffer .= $indent . '                    </div>
...
';
        $buffer .= $indent . '                        <ul>
';
        $buffer .= $indent . '                            <li <img src="icono.png" alt="Icono"><i class="fa fa-clock-o" aria-hidden="true"></i> Horario de Atención al Público:</li>
';
        $buffer .= $indent . '                            <li>Lunes a Viernes</li>
';
        $buffer .= $indent . '                            <li>8:30 - 13:00h / 14:00 - 17:30h</li>
';
        $buffer .= $indent . '                        </ul>
';
        $buffer .= $indent . '                    </div>
...
';
        $buffer .= $indent . '                        <ul>
';
        $buffer .= $indent . '                            <li ><i class="fa fa-phone"></i> (+51-1) 211-7800 </li>
';
        $buffer .= $indent . '                            <li>geo@ceplan.gob.pe</li>
';
        $buffer .= $indent . '                        </ul>
';
        $buffer .= $indent . '                    </div>
...
';
        $buffer .= $indent . '    
';
        $buffer .= $indent . '<!------------------CODIGO MODIFICADO PARA EL FOOTER-------------------------------------->
';
        $buffer .= $indent . '    <div class="copyright" style="background-color: #282829;">
';
...
';
        ...
        $buffer .= '/Assets/Images/logo_ceplan.svg" alt="Geoceplan" style="height: 40px; filter: invert(1);">-->
';
        $buffer .= $indent . '            <!--</a>-->
';
        $buffer .= $indent . '        </div>
';
        $buffer .= $indent . '    </div>
';
        $buffer .= $indent . '    <!------------------FIN CODIGO MODIFICADO PARA EL FOOTER-------------------------------------->
';
