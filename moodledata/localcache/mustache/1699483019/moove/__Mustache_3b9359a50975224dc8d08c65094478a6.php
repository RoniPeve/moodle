...
class __Mustache_3b9359a50975224dc8d08c65094478a6 extends Mustache_Template
{
...
';
        ...
        if (empty($value)) {
            ...
            $buffer .= $this->sectionA89ff104be24cf7a3d66965b8c38c5bf($context, $indent, $value);
...
';
    ...
    private function sectionA89ff104be24cf7a3d66965b8c38c5bf(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= '</button>
';
                $buffer .= $indent . '                </form>llllllllllll
';
                $buffer .= $indent . '            ';
                $context->pop();
            }
