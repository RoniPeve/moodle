...
class __Mustache_3191c2d92298b221c91ee6108aa7f206 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section20e16b34758710601c87a632963e5291($context, $indent, $value);
        $buffer .= $indent . '
';
...
';
        $buffer .= $indent . '            ';
        $value = $context->find('cansignup');
        $buffer .= $this->section6626db35d29cf6f8d2613a88c41085ba($context, $indent, $value);
        $buffer .= $indent . '        </form>
';
        $value = $context->find('hastwocolumns');
        if (empty($value)) {
...
';
    ...
    private function section20e16b34758710601c87a632963e5291(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section6626db35d29cf6f8d2613a88c41085ba(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '<!-----Boton de crear cuenta--------->
