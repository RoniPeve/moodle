...
class __Mustache_72981f019424633b20ec3574d3d64bb1 extends Mustache_Template
{
...
';
        $value = $context->find('cansignup');
        $buffer .= $this->sectionA7c4dbe51bf1d1002b946059bbcbbba6($context, $indent, $value);
        $buffer .= $indent . '        </form>
';
        $value = $context->find('hastwocolumns');
        if (empty($value)) {
            ...
            $buffer .= $this->section37032f03d1eb74764fd08ea0408459e8($context, $indent, $value);
            $buffer .= '<!-- aviso de cookies
';
...
';
        $value = $context->find('hastwocolumns');
        $buffer .= $this->section3b89ea3ed7931a25eb3bfbacb1359b67($context, $indent, $value);
        $buffer .= $indent . '</div>
';
        $buffer .= $indent . '
';
...
';
    ...
    private function sectionA7c4dbe51bf1d1002b946059bbcbbba6(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            $source = '
                <div class="login-signup text-center">
                    aaaaaaaaa{{#str}}donthaveanaccount, theme_moove{{/str}} <a href="{{signupurl}}">{{#str}}startsignup{{/str}}</a>
                </div>
            ';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
            $buffer .= $result;
...
';
    ...
    private function section37032f03d1eb74764fd08ea0408459e8(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            $source = '
                <form action="{{loginurl}}" method="post" id="guestlogin" class="mt-2">
                    ...
                    <input type="hidden" name="password" value="guest" />lllllllll
...
';
                $buffer .= $indent . '                    <input type="hidden" name="password" value="guest" />lllllllll
';
...
';
    ...
    private function section3b89ea3ed7931a25eb3bfbacb1359b67(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
