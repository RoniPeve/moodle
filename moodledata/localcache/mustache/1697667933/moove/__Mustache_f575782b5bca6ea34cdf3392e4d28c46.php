...
class __Mustache_f575782b5bca6ea34cdf3392e4d28c46 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $this->section49ec7f13f85fd4d294319c3b49af8782($context, $indent, $value);
        $value = $context->find('haschildren');
        if (empty($value)) {
...
';
            ...
            if (empty($value)) {
                ...
                $buffer .= $this->sectionA00d35b50656994c2db9bfb9c28b6868($context, $indent, $value);
                $value = $context->find('is_action_link');
                if (empty($value)) {
...
';
    ...
    private function section99ae1b7cf0790e39abfc7a267e0673ef(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section136cd093a76f9f7b8124e332e5886f1e(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                if (empty($value)) {
                    ...
                    $value = $context->find('is_action_link');
                    $buffer .= $this->section99ae1b7cf0790e39abfc7a267e0673ef($context, $indent, $value);
                    $value = $context->find('is_action_link');
                    if (empty($value)) {
...
';
    ...
    private function section49ec7f13f85fd4d294319c3b49af8782(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->section136cd093a76f9f7b8124e332e5886f1e($context, $indent, $value);
                $buffer .= $indent . '        </div>
';
                $buffer .= $indent . '    </li>
';
...
';
    ...
    private function sectionA00d35b50656994c2db9bfb9c28b6868(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
