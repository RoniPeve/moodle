...
class __Mustache_f451ad495fb9f90170f41f4cb19f1643 extends Mustache_Template
{
...
';
        ...
        $buffer .= '/Assets/Images/logo_ceplan.svg" alt="Geoceplan" style="height: 40px;" style:"filter: invert(1);">
';
        $buffer .= $indent . '            </a>
';
        $buffer .= $indent . '        </div>
