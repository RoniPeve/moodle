...
class __Mustache_6cd3a289f4b300b4f0348396d4920de6 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionF42429596e941211c9700c570f23afec($context, $indent, $value);
        $buffer .= $indent . '
';
...
';
    ...
    private function sectionF42429596e941211c9700c570f23afec(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            <div> Hola mundo</div>
            <div id="mooveslideshow" class="container-fluid" class="BannerHome">
        ...
        ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '
';
                $buffer .= $indent . '            <div> Hola mundo</div>
';
                $buffer .= $indent . '            <div id="mooveslideshow" class="container-fluid" class="BannerHome">
';
