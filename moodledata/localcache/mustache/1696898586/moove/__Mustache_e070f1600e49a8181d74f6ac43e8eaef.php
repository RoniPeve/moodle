...
class __Mustache_e070f1600e49a8181d74f6ac43e8eaef extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section6044e5dabec20159fbf8607a5e0d8f5b($context, $indent, $value);
        $buffer .= $indent . '
';
...
';
    ...
    private function section6044e5dabec20159fbf8607a5e0d8f5b(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '
';
                $buffer .= $indent . '            <div class="BannerHome">
';
