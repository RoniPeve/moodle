...
class __Mustache_06c6668b5e727f69cd4b9b9b19be52aa extends Mustache_Template
{
...
';
        $buffer .= $indent . '                    <h3 class="footer-title">Contactanos</h3>
';
        $buffer .= $indent . '
';
        $buffer .= $indent . '                    <ul>
...
';
        ...
        $buffer .= '/Assets/Images/logo_ceplan.svg" alt="Geoceplan" style="height: 40px;" style:"color:#fff;">
';
        $buffer .= $indent . '            </a>
';
        $buffer .= $indent . '        </div>
