...
class __Mustache_aafcdf1849fcd52746f13db1a92d993f extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= '">
';
        $buffer .= $indent . '    <i class="icon fa fa-plus m-0" title="Reopen column" aria-hidden="true"></i>
';
