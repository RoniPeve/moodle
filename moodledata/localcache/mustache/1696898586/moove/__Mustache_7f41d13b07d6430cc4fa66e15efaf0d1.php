...
class __Mustache_7f41d13b07d6430cc4fa66e15efaf0d1 extends Mustache_Template
{
...
';
        $buffer .= $indent . '            <p>';
        $value = $context->find('str');
        $buffer .= $this->sectionD81789b0cce296edd878f999d36e24db($context, $indent, $value);
        $buffer .= '</p>
';
...
';
    ...
    private function sectionD81789b0cce296edd878f999d36e24db(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (!is_string($value) && is_callable($value)) {
            $source = '© Centro Nacional de planeamiento estratégico';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
            $buffer .= $result;
        } elseif (!empty($value)) {
            $values = $this->isIterable($value) ? $value : array($value);
            foreach ($values as $value) {
                ...
                $buffer .= '© Centro Nacional de planeamiento estratégico';
                $context->pop();
            }
        }
